...
なお，本記事を含む図版は以下の GitHub レポジトリから取得できる．\url{https://github.com/kenjihiranabe/The-Art-of-Linear-Algebra/}．また，この記事の内容は2026年に以下のように書籍化された．\url{https://anagileway.com/visual-linear-algebra/}
\end{abstract}
